...
//
//
//har* getCString(std::string str){
//   char * cstr = new char [str.length()+1];
//   std::strcpy (cstr, str.c_str());
//   return cstr;
//
//oid writeSysInfoToConsole(SysInfo sys, WINDOW* sys_win){
//   sys.setAttributes();
//
...
//
//
//oid getProcessListToConsole(std::vector<string> processes,WINDOW* win){
//
...
//  }
//
//oid printMain(SysInfo sys,ProcessContainer procs){
...
int main() {
  std::string p = "3722";
  std::cout << "getVmSize " << ProcessParser::getVmSize(p) << "\n";
  std::cout << "ProcessParser::getSysUpTime " << ProcessParser::getSysUpTime() << "\n";
  std::cout << "ProcessParser::getProcUpTime " << ProcessParser::getProcUpTime(p) << "\n";
  std::cout << "ProcessParser::getCpuPercent " << ProcessParser::getCpuPercent(p) << "\n";
  std::cout << "ProcessParser::getProcUser " << ProcessParser::getProcUser(p) << "\n";
